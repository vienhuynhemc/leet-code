...
public class RemoveStonesToMinimizeTheTotal {
  ...
  public static void main(String[] args) {
    ...
    int[] largeArray = LoadArray.getInstance()
      .loadIntArrayFromFile("src/main/resources/test-data/remove-stones-to-minimize-the-total.txt");
    ...
    System.out.println(
      removeStonesToMinimizeTheTotal.minStoneSum(new int[] { 2695, 9184, 2908, 3869, 3779, 391, 2896, 5328 }, 10)
    );
  }
}
