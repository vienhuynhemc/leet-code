...
public class ValidWord {
    ...
    private boolean isVowel(int decimalValue) {
        return decimalValue == 65 || decimalValue == 69 || decimalValue == 73 || decimalValue == 79
                || decimalValue == 85 || decimalValue == 97 || decimalValue == 101 || decimalValue == 105
                || decimalValue == 111 || decimalValue == 117;
    }
