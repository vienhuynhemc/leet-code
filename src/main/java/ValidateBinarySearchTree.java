...
public class ValidateBinarySearchTree {
  ...
  private boolean isValidBST(TreeNode root, boolean isLeft, int limit) {
    ...
    return (
      isValidBST(root.left, true, isLeft, isLeft ? 0 : limit, root.val, !isLeft) &&
  ...
  private boolean isValidBST(
    ...
    if (isBeforeLeft) {
      if (isLeft) {
        ...
        return (
          isValidBST(root.left, true, true, bottom, root.val, isDifferent) &&
        ...
        return (
          isValidBST(root.left, true, false, bottom, root.val, true) &&
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
      validateBinarySearchTree.isValidBST(
