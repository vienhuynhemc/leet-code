...
public class SolvingQuestionsWithBrainpower {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
      solvingQuestionsWithBrainpower.mostPoints(new int[][] { { 3, 2 }, { 4, 3 }, { 4, 4 }, { 2, 5 } })
    );
    System.out.println(
      solvingQuestionsWithBrainpower.mostPoints(
        new int[][] { { 21, 5 }, { 92, 3 }, { 72, 2 }, { 39, 4 }, { 58, 2 }, { 5, 5 }, { 49, 4 }, { 65, 3 } }
      )
    );
  }
}
