...
public class NumberOfSubsequencesThatSatisfyTheGivenSumCondition {
  ...
  public static void main(String[] args) {
    NumberOfSubsequencesThatSatisfyTheGivenSumCondition numberOfSubsequencesThatSatisfyTheGivenSumCondition =
    ...
    System.out.println(
      numberOfSubsequencesThatSatisfyTheGivenSumCondition.numSubseq(new int[] { 2, 3, 3, 4, 6, 7 }, 12)
    );
    System.out.println(
      numberOfSubsequencesThatSatisfyTheGivenSumCondition.numSubseq(
        new int[] {
          14,
          4,
          6,
